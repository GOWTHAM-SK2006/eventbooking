...
export default function BookingsPage() {
  ...
  const getFilteredBookings = () => {
    return bookings.filter(b => {
      ...
      const isConfirmed = b.status === 'CONFIRMED' || !b.status;
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl md:text-5xl font-black tracking-tight flex items-baseline gap-2">
                <span>Bookings &</span>
                <span className="text-[#EAB308]">Purchases</span>
              </h1>
            ...
            <div className="flex gap-2">
              <span className="text-[10px] font-black text-[#EAB308] bg-yellow-50 border border-yellow-250 px-3 py-1 rounded-xl uppercase tracking-wider">
